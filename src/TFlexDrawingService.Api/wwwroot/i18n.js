...
const ENGLISH_BY_RUSSIAN = new Map([
  ...
  ["Сбросить все параметры и вернуть значения по умолчанию?", "Reset all parameters to their default values?"],
  ["Предыдущие категории", "Previous categories"],
  ["Следующие категории", "Next categories"],
  ["Проверьте значение параметра.", "Check the parameter value."],
  ["Проект", "Project"],
  ["Шаблон", "Template"],
  ...
  ["Обновить расчёт", "Update calculation"],
  ["Расчёт обновляется автоматически при изменении параметров.", "The calculation updates automatically when parameters change."],
